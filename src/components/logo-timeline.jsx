      ...
      <div className="@container absolute inset-0 grid grid-cols-1 pt-8">
        <Row>
          <Logo
            ...
            src="/logo-timeline/reply-reviews.svg"
            className="[animation-delay:-26s] [animation-duration:30s]"
          />
          <Logo
            label="Profile Description"
            src="/logo-timeline/profile-description.svg"
        ...
        <Row>
          <Logo
            label="Services"
            src="/logo-timeline/services.svg"
            className="[animation-delay:-40s] [animation-duration:40s]"
          />
          <Logo
            label="Additional Categories"
            src="/logo-timeline/sub-categories.svg"
        ...
        <Row>
          <Logo
            label="Verification"
            src="/logo-timeline/verification.svg"
            className="[animation-delay:-45s] [animation-duration:45s]"
          />
          <Logo
            label="Attributes"
            src="/logo-timeline/attributes.svg"
        ...
        <Row>
          <Logo
            label="Photos"
            src="/logo-timeline/photos.svg"
            className="[animation-delay:-55s] [animation-duration:60s]"
          />
          <Logo
            label="Socials"
            src="/logo-timeline/socials.svg"
        ...
        <Row>
          <Logo
            label="Videos"
            src="/logo-timeline/videos.svg"
            className="[animation-delay:-9s] [animation-duration:40s]"
          />
          <Logo
            label="Google Posts"
            src="/logo-timeline/posts.svg"
